...
def create_experiment(beaker: Beaker, author_id_list: List, experiment_idx: int) -> str:
    ...
    experiment_name = f"get_author_persona_distances_min-year-2017_run00_{experiment_idx:04d}"
    command = [
        "python",
        "-u",
        ...
        tasks=[
            TaskSpec(
                ...
                datasets=[
                    ...
                    DataMount(
                        source=DataSource(beaker="01GZA25AFPWKDJ5DDCYFFQG65P"),  # personas for 2017
...
def main(args):
    ...
    for i, chunk in enumerate(chunks(author_ids, 1500)):
