...
DESCRIPTION = """takes a directory of pickle files---each file contains bridger recommendations for one author---and combines them, saving to a single pickle file"""
...
def main(args):
    ...
    recs = {}
    for fp in input_dir.glob("*.pickle"):
